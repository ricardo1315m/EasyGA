...
class Population:
    def __init__(self, chromosome_list):
        ...
        self.chromosome_list = [
            make_chromosome(chromosome) for chromosome in chromosome_list
        ]
        self.mating_pool = []
    ...
    def append_children(self, chromosome_list):
        ...
        self.next_population += (
            to_chromosome(chromosome) for chromosome in chromosome_list
        )
    ...
    def sort(self, *, key=lambda chromosome: chromosome.fitness, reverse):
        ...
        self.chromosome_list.sort(key=key, reverse=reverse)
